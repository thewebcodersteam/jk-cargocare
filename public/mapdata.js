var simplemaps_countrymap_mapdata = {
  main_settings: {
    ...
    location_size: 45, // Increased size
    location_type: "image",
    location_image_source: "/assets/images/location-marker.png",
    ...
    auto_load: "yes",
    url_new_tab: "no",
    images_directory: "", // Crucial to allow correct public path
    fade_time: 0.1,
  ...
  state_specific: {
    ...
    INAP: { name: "Andhra Pradesh" },
    INAR: { name: "Arunachal Pradesh" },
    INAS: { name: "Assam" },
    INBR: { name: "Bihar" },
    INCH: { name: "Chandigarh" },
    INCT: { name: "Chhattisgarh" },
    INDH: { name: "Dādra and Nagar Haveli and Damān and Diu" },
    INDL: { name: "Delhi" },
    INGA: { name: "Goa" },
    INGJ: { name: "Gujarat" },
    INHP: { name: "Himachal Pradesh" },
    INHR: { name: "Haryana" },
    INJH: { name: "Jharkhand" },
    INJK: { name: "Jammu and Kashmir" },
    INKA: { name: "Karnataka" },
    INKL: { name: "Kerala" },
    INLA: { name: "Ladakh" },
    INLD: { name: "Lakshadweep" },
    INMH: { name: "Maharashtra" },
    INML: { name: "Meghalaya" },
    INMN: { name: "Manipur" },
    INMP: { name: "Madhya Pradesh" },
    INMZ: { name: "Mizoram" },
    INNL: { name: "Nagaland" },
    INOR: { name: "Orissa" },
    INPB: { name: "Punjab" },
    ...
    INSK: { name: "Sikkim" },
    INTG: { name: "Telangana" },
    INTN: { name: "Tamil Nadu" },
    INTR: { name: "Tripura" },
    INUP: { name: "Uttar Pradesh" },
    INUT: { name: "Uttaranchal" },
    INWB: { name: "West Bengal" }
  },

  locations: {
    "0": { name: "Goa", lat: "15.2993", lng: "74.1240" },
    "1": { name: "Maharashtra", lat: "19.7515", lng: "75.7139" },
    "2": { name: "Gujarat", lat: "22.2587", lng: "71.1924" },
    "3": { name: "Rajasthan", lat: "27.0238", lng: "74.2179" },
    "4": { name: "Madhya Pradesh", lat: "22.9734", lng: "78.6569" },
    "5": { name: "Karnataka", lat: "15.3173", lng: "75.7139" },
    "6": { name: "Tamil Nadu", lat: "11.1271", lng: "78.6569" },
    "7": { name: "Uttar Pradesh", lat: "26.8467", lng: "80.9462" },
    "8": { name: "Bihar", lat: "25.0961", lng: "85.3131" },
    "9": { name: "Delhi", lat: "28.6139", lng: "77.2090" },
    "10": { name: "Andhra Pradesh", lat: "15.9129", lng: "79.7400" },
    "11": { name: "Kerala", lat: "10.8505", lng: "76.2711" },
    "12": { name: "Chhattisgarh", lat: "21.2787", lng: "81.8661" }
  },
  ...
  labels: {
    ...
    INDH: { name: "Dādra and Nagar Haveli and Damān and Diu", parent_id: "INDH" },
